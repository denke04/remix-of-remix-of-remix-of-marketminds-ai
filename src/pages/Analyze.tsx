...
const analysisResult = {
  ...
  tips: [
    "Start with your most eye-catching moment",
      ...
      <div className="min-h-screen px-4 py-6 pb-24">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Upload content to get AI feedback
          </p>
        </div>
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 p-4 rounded-xl bg-card border border-primary/50 flex items-center justify-center gap-2">
                  <Image className="w-5 h-5 text-primary" />
                  <span className="text-sm font-medium">Photo</span>
                </button>
                <button className="flex-1 p-4 rounded-xl bg-card border border-border flex items-center justify-center gap-2 hover:border-primary/50 transition-colors">
